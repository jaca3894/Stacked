export const welcomeCardsData = [
  {
    title: "Host games",
    description:
      "You've got only deck of cards? Simulate game's board by playing with virtual money.",
    photoPath: require("../assets/welcome/ss1.png"),
  },
  {
    title: "Learn basics and more",
    description:
