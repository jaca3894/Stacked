...
export const welcomeCardsData = [
    { title: 'Host games', description: "You've got only deck of cards? Simulate game's board by playing with virtual money.", photoPath: require("../assets/welcome/ss1.png") },
    { title: 'Learn basics and more', description: "We've got tutorials for everything: from game rules to card flourishes.", photoPath: require("../assets/welcome/ss2.png") },
    { title: 'Check your poker hand', description: "Not sure if your cards line up into something? Use our tool to find out.", photoPath: require("../assets/logo/logo.png") }
  ];

export const morePanelsData = [
  { title: 'Check hand', imagePath: require('../assets/morePanel/pokerHand.jpg'), panel: SettingsPanel },
  { title: 'Glossary', imagePath:  require('../assets/morePanel/dictionary.jpg'), panel: SettingsPanel },
  { title: 'Report a bug', imagePath: require('../assets/morePanel/reportBug.jpg'), panel: SettingsPanel },
  { title: 'Patch notes', imagePath: require('../assets/morePanel/patchNotes.jpg'), panel: SettingsPanel },
  { title: 'Credits', imagePath:  require('../assets/morePanel/credits.jpg'), panel: SettingsPanel },
  { title: 'Settings', imagePath: require('../assets/morePanel/settings.jpg'), panel: SettingsPanel },
];
...
export const skillsData = [
  {
    ...
    items: [
      { name: 'Poker', imagePath: require('../assets/skills/poker.png') },
      { name: 'Blackjack', imagePath: require('../assets/skills/blackjack.jpg') },
      { name: 'Roulette', imagePath: require('../assets/skills/roulette.png') }
    ]
  },
  {
    ...
    items: [
      { name: 'Riffle shuffle', imagePath: require('../assets/skills/riffleShuffle.gif') },
      { name: 'Faro shuffle', imagePath: require('../assets/skills/faroShuffle.gif') },
      { name: 'Charlier Cut', imagePath: require('../assets/skills/charlierCut.gif') },
    ]
  },
  {
    category: 'Flourishes',
    ...
    items: [
      { name: 'Card spring', imagePath: require('../assets/skills/cardSpring.gif') },
      { name: 'Card fan', imagePath: require('../assets/skills/cardFan.gif') },
      { name: 'Ribbon spread', imagePath: require('../assets/skills/ribbonSpread.gif') }
    ]
  }
];
